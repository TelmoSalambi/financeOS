...
const ActivityItem = ({ icon: Icon, title, date, category, amount, isNegative }) => {
  ...
  return (
    <div className="px-4 md:px-8 py-5 flex items-center justify-between hover:bg-slate-50 transition-all duration-300 border-l-4 border-transparent hover:border-primary group">
          ...
          <div className="divide-y divide-slate-100">
            {loading ? (
              <div className="p-12 md:p-16 text-center text-slate-400 flex flex-col items-center gap-3">
                ...
                <p className="font-semibold text-sm">A carregar histórico...</p>
              </div>
